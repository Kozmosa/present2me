...
```json
{
  ...
  "startBinding": { "elementId": "node-1", "focus": 0, "gap": 1, "fixedPoint": null },
  "endBinding":   { "elementId": "node-2", "focus": 0, "gap": 1, "fixedPoint": null },
  "startArrowhead": null,
  "endArrowhead": "arrow",      // arrow|triangle|dot|bar; 无箭头用 null
...
```json
{ "type": "freedraw", "points": [[0,0],[10,3],[25,8]], "simulatePressure": true, ... }
```
